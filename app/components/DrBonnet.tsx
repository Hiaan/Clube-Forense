        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-4 text-sm text-purple-300">
              <strong>Disponível 24 horas.</strong> Estude de madrugada, no fim de semana ou em
              qualquer horário — o Dr. Bonnet está sempre disponível com respostas de qualidade.
            </div>
          </div>

          {/* Right: chat mockup */}
          <div className="bg-[#0d1220] border border-white/8 rounded-2xl overflow-hidden shadow-2xl shadow-purple-900/10">
            {/* Chat header */}
            ...
            <div className="p-5 space-y-4 min-h-[280px]">
              ...
              <div className="flex justify-start">
                <div className="bg-white/5 border border-white/6 rounded-2xl rounded-tl-sm px-4 py-3 flex gap-1 items-center">
                  {[0, 1, 2].map((i) => (
                    <div
                      key={i}
            ...
            <div className="border-t border-white/5 px-4 py-3 flex gap-2">
              <div className="flex-1 bg-white/5 border border-white/8 rounded-xl px-3 py-2 text-xs text-slate-600">
