    ...
    <section id="inscricao" className="py-24 px-6 border-t border-white/5">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-slate-400 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
          ...
          Garanta sua vaga na mentoria que tem 100% de aprovação nos 1ºs lugares.
        </p>

        {/* Benefits list */}
        <div className="bg-[#0d1220] border border-white/8 rounded-2xl p-6 mb-10 text-left max-w-md mx-auto">
          <div className="text-sm font-semibold text-white mb-4">O que você leva:</div>
        ...
        <a
          href="#"
          className="inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-500 text-white font-bold px-10 py-5 rounded-xl text-lg transition-all hover:shadow-2xl hover:shadow-blue-500/30 hover:-translate-y-0.5 mb-4"
        >
