...
//
// Cliente por causa do estado de espera. A coleta refaz 64 buscas sem cache e
// leva dezenas de segundos — um botão que não avisa disso parece travado, e
// quem administra clica de novo, dobrando o trabalho à toa.
...
export default function BotaoColetar({ uf }: { uf: string }) {
    ...
    <form onSubmit={enviarSemLimpar(acao)} className="mt-4 border-t border-gray-100 pt-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <span className="text-xs text-gray-400">
          {coletando
            ? "Refazendo as 64 buscas. Pode levar meio minuto — não feche a página."
